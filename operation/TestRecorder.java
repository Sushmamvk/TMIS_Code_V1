/**
 * TestRecorder class is to perform Test Recording and save the video as a file in Output folder
 */
package operation;
...
/**
 * <p>To configure Screen Recorder
 */
public class TestRecorder extends ScreenRecorder {
    private String name;

    public TestRecorder(GraphicsConfiguration cfg,
